...
package edu.uwec.cs.kunseljp.program5;
...
class Huffman {
	...
	public Huffman(String fileName) {
		...
		System.out.println("Entropy: " + t.entropy() + ", Ave. Code Length: " + t.aveCodeLen());
	}
	...
	public void displayTreeRecurs(TreeNode tree) {
		...
		if (tree != null) {
			...
			System.out.print(tree.symb + ": " + fourDigits.format(tree.weight) + ", " + tree.rep);
			if (depth != 1)
	...
	public static void main(String[] args) {
		...
		huff = new Huffman("edu/uwec/cs/kunseljp/program5/WoWChap1.txt");
